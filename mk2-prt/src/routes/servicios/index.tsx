...
export const Route = createFileRoute("/servicios/")({
  head: () => ({
    meta: [
      ...
      { name: "keywords", content: "servicios salon, manicure pedicure, cabello, nail salon" },
...
const categories = [
  {
    ...
    img: "/brand/servicios-manicure.jpg",
    tag: "Desde $30",
  },
  {
    title: "Pedicure",
    ...
    img: "/brand/servicios-pedicure.jpg",
    tag: "Desde $50",
  },
  {
    title: "Cabello",
    ...
    img: "/brand/servicios-cabello.jpg",
    tag: "Desde $25",
  },
  {
    title: "Cabinas",
    ...
    img: "/brand/servicios-cabinas.jpg",
    tag: "Info",
  },
];
  ...
  return (
    <div style={{ background: "#feeff2", color: "#2a1a20", minHeight: "100vh" }}>
      ...
      <section style={{ position: "relative", minHeight: "clamp(280px,40vw,420px)", overflow: "hidden", display: "flex", alignItems: "flex-end" }}>
        <img src="/brand/servicios-hero.jpg" alt={`${business.name} servicios`} style={{ position: "absolute", inset: 0, width: "100%", height: "100%", objectFit: "cover" }} />
      ...
      <section style={{ maxWidth: 1100, margin: "0 auto", padding: "80px 2rem" }}>
        ...
        <div style={{ marginTop: 64, padding: "40px 32px", background: "#2a1a20", color: "#fff", textAlign: "center" }}>
          <p style={{ fontFamily: ffS, fontSize: "clamp(18px,3vw,26px)", fontWeight: 400, color: "#fff", marginBottom: 12 }}>El salón favorito de {business.legalCity}</p>
          <p style={{ fontFamily: ff, fontSize: 12, color: "rgba(255,255,255,0.6)", lineHeight: 1.9, maxWidth: 520, margin: "0 auto 24px" }}>
            {business.address}<br/>
            ⭐ {business.googleRating.value} estrellas · Walk-ins bienvenidos · Parking disponible · Tarjetas aceptadas
          </p>
          <Link to="/" hash="agendar"
